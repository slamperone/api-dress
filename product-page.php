...
<body id="unchanged" class="product-page">
    ...
    <div class="detalles-producto">
        <div class="caracteristicas">
            <table cellspacing="12" cellpadding="12">
                <tr>
                    <td>Corte</td>
                    <td class="lower" >Semi-Amplio . I pieza</td>
                </tr>
                <tr>
                    <td>Material</td>
                    <td class="lower">Cauda  Desmontable</td>
                </tr>
                <tr>
                    <td>Colores</td>
                    <td class="lower">Ivory, Blanco</td>
                </tr>
                <tr>
                    <td>Características</td>
                    <td class="lower">Aplicación Importada</td>
                </tr>
                <tr>
                    <td>Tallas</td>
                    <td class="lower">A30, 34 ,40</td>
                </tr>
            </table>
        </div>
...
var opciones = {
    ...
    zoomWidth: 500,
    zoomPosition: 'right',
    offset: {vertical: 0, horizontal: 170},
    img: './img/vestido-zoomed.jpg',
};

new ImageZoom(document.getElementById("img-container"), opciones);
</script>
