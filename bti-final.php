...
<?php include "header.php"?>
    ...
    <figure class="zoom" onmousemove="zoom(event)" style="background-image: url(https://xochimaco.com/b879e89b97f4/diana-di-giorno/img/vestido-prod.jpg)">
        <img src="https://xochimaco.com/b879e89b97f4/diana-di-giorno/img/vestido-prod.jpg" />
    </figure>
    <div id="image-wrapper">
        <img class="thumbnail it_selected" src="https://xochimaco.com/b879e89b97f4/diana-di-giorno/img/vestido-prod.jpg" alt="">
        <img class="thumbnail" src="https://xochimaco.com/b879e89b97f4/diana-di-giorno/img/vestido-prod-b.jpg" alt="">
    </div>
        <div id="description">
            <h4>JANE</h4>
    ...
    <h3>Otras opciones</h3>
        <div class="vestidos-container">
            <a href="" class="container-vestidos">
                <img class="image-prim" src="./img/vestido.jpg" alt="">
